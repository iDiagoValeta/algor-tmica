...
def damerau_restricted(x, y, threshold):
    '''
        Calcula la distancia de Damerau-Levenshtein restringida
        usando reducción de espacio y parada por threshold.
    '''
    lenX, lenY = len(x), len(y)
...
def damerau_intermediate(x, y, threshold):
    '''
        Calcula la distancia de Damerau-Levenshtein intermedia
        usando reducción de espacio y parada por threshold.
    '''
    lenX, lenY = len(x), len(y)
